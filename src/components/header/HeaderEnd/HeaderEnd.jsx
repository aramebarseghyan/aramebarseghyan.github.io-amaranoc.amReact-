...
const HeaderEnd = ({ className, isLoggedIn, onLogout }) => {
  return (
    <div className={`flex items-center gap-4 md:gap-8 ${className || ""}`}>
      ...
      <div className="hidden md:flex items-center border border-gray-300 h-[45px] w-[200px] lg:w-[250px] rounded-[25px] pl-5 pr-4 focus-within:border-black transition-colors">
        <HeaderEnd3
          place={"Որոնում"}
