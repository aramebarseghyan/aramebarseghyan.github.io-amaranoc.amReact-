...
const Region = () => {
  return (
    <div className="w-[290px] absolute top-[50px] left-[25px]">
      {" "}
      <h3 className="absolute bottom-[230px]  text-[16px] font-bold text-[#111]">
        Տարածաշրջան
      </h3>
        ...
        {regionsList.map((region, index) => (
          <p key={index} className="flex items-center gap-3 mb-3.5">
            <input
              type="checkbox"
              id={`region-${index}`}
              className="cursor-pointer pt w-4 h-4 rounded border-gray-300 accent-[#111]"
            />
            <label
